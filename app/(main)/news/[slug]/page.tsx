...
const newsDetails: Record<string, {
  ...
  "2026-04-14-seminar-2": {
    paper_title: "2026年度 第2回教室説明会のお知らせ",
    authors: "",
    journal: "",
    url: "",
    abstract: "横浜市立大学 消化器内科学教室の第2回教室説明会を 2026年5月22日（金）19時からハイブリッド形式で開催致します。\n\n消化器内科医を志している方、当教室に少しでも興味がある方は、この機会にぜひご参加下さい。\n\n説明会の後半で専攻医の先生方に気軽に質問いただけるようなお時間も用意しております。待遇面や施設の内情など気になることはなんでも質問していただき参考にして頂ければ幸いです。\n\nまた、説明会後には懇親会を予定しています。多くの皆様のご参加をお待ちしております。\n\n【開催概要】\n・開催日時：2026年5月22日（金）19時〜\n・開催形式：ハイブリッド開催（現地およびZOOM開催）\n・現地：横浜市立大学みなとみらいサテライトキャンパス 横浜ランドマークタワー 7F\n・ZOOM参加の方には、開催前日にURLを送付いたします。\n\n事前申し込み制となっておりますので、見学・入局相談ページより登録をお願い致します。",
    comment: ""
  },
  "2026-03-23-michibata-stomal": {
    paper_title: "Long cap-assisted visualization enabling bleeding point identification and clip hemostasis for stomal variceal bleeding",
    authors: "Nobutaka Michibata, et al.",
    journal: "Endoscopy. 2026 Mar;58(S 01):E414-E415.",
    url: "https://pubmed.ncbi.nlm.nih.gov/41856506/",
    abstract: "ストマ静脈瘤破裂の1例を報告しました。本症例は血便を主訴に入退院を繰り返しておりましたが、再受診時にストマ辺縁からの出血を疑い内視鏡を施行しました。ロングキャップ（突出長12 mm）を使用することで視野が安定し、出血点の同定およびクリップ止血に成功しました。本症例は、原因不明の消化管出血においてストマ静脈瘤の関与を考慮する重要性と、ロングキャップの有用性を示すものと考えられます。",
    comment: "ストマ静脈瘤破裂の1例を、このたび報告させていただきました。\n\n本症例は血便を主訴に入退院を繰り返しておりましたが、再受診時にストマ辺縁からの出血を疑い内視鏡を施行しました。\n\nロングキャップ（突出長12 mm）を使用することで視野が安定し、出血点の同定およびクリップ止血に成功しました。\n\n本症例は、原因不明の消化管出血においてストマ静脈瘤の関与を考慮する重要性と、ロングキャップの有用性を示すものと考えられます。\n\n本報告が日常診療の一助となれば幸いです。\n\n日頃よりご指導いただいております前田教授に深く感謝申し上げます。（道端）"
  },
