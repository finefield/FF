  ...
  return (
    <div className="space-y-6">
      ...
      <div className="reveal rounded-2xl bg-white border border-border p-6 md:p-8">
        ...
        <p className="mt-3 text-sm leading-[1.9] text-text-sub">
          その造影剤を用いて三次元で腫瘍を描出することで診断や治療の効果判定にもちい��り、またCTやMRIを参照にする融合画像を用いることで、超音波だけでは検出できない病変を検出し、超音波ガイドで治療したり、それを効果判定することも可能になった。点滴の必要があるが、誰でも安心、安全により精密な検査をうけることができ、その結果、診断と治療方針を決定することができる検査である。<strong className="text-teal">2016年は約600件施行</strong>しております。
        </p>
        <div className="mt-6 bg-gray-50 p-4 rounded-lg">
          <Image
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="reveal rounded-2xl bg-white border border-border p-6 md:p-8">
        ...
        <p className="mt-3 text-sm leading-[1.9] text-text-sub">
          近年、胆膵領域においても専門分野の細分化が進み、内視鏡治療医と化学療法を行う腫瘍内科医が別々に診療を行う施設や教育機関が増えてきていました。しかしながら、胆道癌や膵癌は、化学療法中に閉塞性黄疸や胆管炎、消化管閉塞等の様���な病態が合併・併存することが多く、病態に応じてステント留置等の内視鏡的治療介入が必要となる領域です。当教室では胆膵内視鏡治療と化学療法の双方の専門性を併せ持った胆膵専門医の育成を図ることで、<strong className="text-teal">組織診断・化学療法・内視鏡的治療介入が三位一体となったシームレスな医療提供</strong>を目指しています。
        </p>
        <p className="mt-3 text-sm leading-[1.9] text-text-sub">
    ...
    <div className="space-y-6">
      <div className="reveal rounded-2xl bg-white border border-border p-6 md:p-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-text-sub">
          何よりも安全を第一に、患者さまにとって病気の根治性を損ねることなく低侵襲なより良い治療を提供でき��よう心がけております。同センターを内視鏡治療の教育施設として、これまで多くの内視鏡治療医を協力病院へと輩出しております。協力病院がそれぞれ��地域での内視鏡治療の基幹病院となるよう、グループ一丸となって内視鏡治療を推進しております。
        </p>
        <div className="mt-6">
          <Image
      ...
      <div className="reveal rounded-2xl bg-white border border-border p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-text-sub">
          早期消化管癌に対するESDが普及してきている現在、いかに癌を早期に発見することが課題となっております。最近では、NBI(narrow band imaging)、BLI(blue laser imaging)などの狭帯域���観察による診断技術も普及し、消化管癌の検出率の向上が言われております。しかし、その観察には正常と異常を見分ける診断力が必要です。そのため、カンファレンスを行い、拡大観察における診断力の向上や、早期癌の発見のための観察トレーニングを日々徹底しております。さらに、内視鏡所見だけでなく、病理所見や遺伝子変異情報を網羅的に検討する取り組みを行っております。
        </p>
        <p className="mt-3 text-sm leading-relaxed text-text-sub">
