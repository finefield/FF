    ...
    <footer className="bg-[#070E1A] text-white">
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Column 3: 入局・研修 */}
          <div>
            <p className="mb-4 text-sm font-bold text-[#C4923A]">入局・研修</p>
            <ul className="flex flex-col gap-2.5 text-sm text-white/60">
              <li><Link href="/recruit" className="transition-colors hover:text-white">教育・研修の特徴</Link></li>
              ...
              <li><Link href="/recruit/hospitals" className="transition-colors hover:text-white">連携病院ネットワーク</Link></li>
              <li><Link href="/recruit/visit" className="transition-colors hover:text-white">見学・入局相談フォーム</Link></li>
